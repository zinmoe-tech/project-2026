...
socket.on("message", function(message) {
  function showCount(record) {
    ...
    $("#dashboard-hostname").text("Container/Host: " + (message.dashboard_hostname || "-"))
    $("#dashboard-ip").text("Container IP: " + (message.dashboard_ip || "-"))
    $("#container-id").text("Container ID: " + (message.container_id || "-"))
    $("#image-name").text("Image: " + (message.image_name || "-"))
  }
